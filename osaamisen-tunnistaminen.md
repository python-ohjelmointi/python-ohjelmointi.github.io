...
Jos olet hankkinut tämän opintojakson mukaisen osaamisen työn, harrastuksen tai muiden kurssien kautta, voit osoittaa osaamisesi tehtävien ja kokeiden sijasta AHOT-menettelyllä. Ilmoittaudu tälle kurssille normaalisti ja ole yhteydessä kurssin opettajiin AHOT-järjestelyjen osalta **viimeistään kurssin ensimmäisen viikon aikana**.
