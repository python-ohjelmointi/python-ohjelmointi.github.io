...
>
> [mooc.fi](https://ohjelmointi-26.mooc.fi/osa-6/1-tiedostojen-lukeminen)
...
Tehtävässä [kurssien tilastot](https://ohjelmointi-26.mooc.fi/osa-7/4-datan-kasittely#netissa-olevan-tiedoston-hakeminen) moni opiskelija törmää SSL-sertifikaattivirheeseen. Tämä johtuu studies.cs.helsinki.fi-palvelimen sertifikaatista.
